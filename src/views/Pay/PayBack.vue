  ...
  <div class="rs-pay-page">
    <div class="container">
      ...
      <div class="pay-result">
        ...
        <div class="btn">
          <el-button type="primary" style="margin-right:20px; color:#fff;background-color:#a456d4; border: none">查看订单</el-button>
          <el-button>进入首页</el-button>
        </div>
        <p class="alert">
          <span class="iconfont icon-tip"></span>
          温馨提示：R-STAR不会以订单异常、系统升级为由要求您点击任何网址链接进行退款操作，保护资产、谨慎操作。
        </p>
      </div>
    </div>
  </div>
